...
if (!defined('__CLASS_QRCODE__')) {
  ...
  class QRcode {
    ...
    private $data_val = [];  // liste des valeurs de bit diff�rents

    private $data_word = [];  // liste des valeurs tout ramen� � 8bit
     ...
     * @return  boolean true;
     */
    public function displayFPDF(&$fpdf, $x, $y, $w, $background = [
      255,
      255,
      255,
    ],                          $color = [0, 0, 0]) {
     ...
     * @return	boolean	true;
     */
    public function displayPNG($w = 100, $background = [
      255,
      255,
      255,
    ],                         $color = [
